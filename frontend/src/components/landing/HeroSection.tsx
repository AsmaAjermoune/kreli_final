...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #0f0520 0%, #1a0a2e 35%, #1a1a2e 65%, #0d1a35 100%)",
      }}>
      ...
      <motion.div
        ...
        <div
          className="absolute -top-32 -right-32 h-[700px] w-[700px] rounded-full animate-gentle-pulse"
          style={{
            background:
              "radial-gradient(circle, rgba(236,72,153,0.18) 0%, rgba(244,63,94,0.08) 50%, transparent 70%)",
          }}
        />
        
        <div
          className="absolute -bottom-40 -left-40 h-[600px] w-[600px] rounded-full animate-gentle-pulse animation-delay-1000"
          style={{
            background:
              "radial-gradient(circle, rgba(0,78,152,0.25) 0%, rgba(167,139,250,0.08) 50%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(253,186,116,0.05) 0%, transparent 70%)",
          }}
        />
        ...
        {[
          ...
          <motion.div
            ...
            <Heart
              fill="currentColor"
              style={{ color: "#f472b6", width: h.size, height: h.size }}
            />
          </motion.div>
        ))}
        ...
        {[
          ...
          <motion.div
            ...
            <Sparkles
              style={{ color: "#fbbf24", width: 14, height: 14, opacity: 0.5 }}
            />
          </motion.div>
        ))}
      </motion.div>
        ...
        <motion.div
          ...
          <motion.div variants={item}>
            <span
              ...
              <Heart
                className="h-3.5 w-3.5 fill-current animate-heartbeat"
                style={{ color: "#f472b6" }}
              />
          ...
          <motion.h1
            ...
            <span className="relative inline-block">
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #ff6700 0%, #ec4899 50%, #f43f5e 100%)",
              ...
              <motion.span
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #ff6700, #ec4899, #f43f5e)",
                }}
          ...
          <motion.p
            ...
            style={{ color: "#cbd5e1" }}>
            BTP, outillage, événementiel, agriculture — trouvez
            l&apos;équipement idéal parmi des centaines d&apos;annonces
          ...
          <motion.form
            ...
            <div
              className="flex flex-1 items-center gap-3 rounded-2xl px-4 py-3 backdrop-blur-md transition-all"
              style={{
            ...
            <div
              className="flex items-center gap-3 rounded-2xl px-4 py-3 backdrop-blur-md transition-all sm:w-44"
              style={{
                border: "1px solid rgba(255,255,255,0.15)",
                background: "rgba(255,255,255,0.08)",
              }}>
              ...
              <select
                ...
                {CITIES.map((c) => (
                  <option key={c} value={c} className="bg-[#1a0a2e]">
                    {c}
                  </option>
                ))}
              </select>
