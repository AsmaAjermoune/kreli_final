...
class App {
  ...
  onTouchUp(e) {
    ...
    const moved = Math.abs(endX - this.scrollStartX);

    if (moved < 8 && this.onItemClick && this.medias && this.medias.length) {
      
      const viewportX = ((endX - this.screen.width / 2) / this.screen.width) * this.viewport.width;
      let closestIdx = 0;
      ...
      this.onItemClick(closestIdx % this.originalLength);
    }
